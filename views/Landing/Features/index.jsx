    ...
    <div className={styles.container} id="features">
      <div className={styles.content}>
        ...
        <div className={styles.cards}>
          <motion.div className={styles.card} animate={inView ? 'visible' : 'hidden'}
						variants={variants}
						transition={{ duration: 1, ease: 'easeOut' }}
						ref={ref}>
            <h3>Feature Headline</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam quia fuga numquam, cupiditate.</p>
          </motion.div>
          <motion.div className={styles.card} animate={inView ? 'visible' : 'hidden'}
						variants={variants}
						transition={{ duration: 1, ease: 'easeOut' }}
