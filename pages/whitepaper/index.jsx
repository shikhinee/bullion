        ...
        <div className={styles.content}>
          ...
          <section id="introduction">
            ...
            <p>
              ...
              and prejudice plaguing our global economy that has induced a wide
              array of systemic instabilities. By drawing from the strengths of
              the former &quot;Bretton Woods System&quot; where currencies were
              backed by gold reserves, we not only seek to remedy the economic
              shock that has perturbed the under-serviced members of society,
              but also proffer an opportunity to become productive economic
              agents, at liberty, to realize their economic aspirations.
              Focusing on the issues plaguing global finance, specifically, the
              market for loans, BULLION connects savers and borrowers in the
              current banking and financial sector to receive equitable access
              to more competitive financial services all within a decentralized
              environment.
            </p>
            <p>
              Recent advancements of blockchain technology, specifically
              decentralized finance (DeFi), have enabled the creation of
              sophisticated decentralized financial primitives that are akin to
              services offered in the legacy financial system, including loans,
              payments, and derivatives, to name a few. By eliminating
              intermediaries altogether, BULLION aims to create a more
              accessible, equitable, and economically attractive banking system
              where participants of BULLION reap all of the benefits. We
              champion the cause for non-major producers, savers, and investors
              of commodities, such as gold, platinum, silver, or copper, who are
              inadequately serviced by today’s legacy financial system. BULLION
              aims to contribute to financial inclusion by providing access to
              optimally priced capital to commodity owners and opportunities for
              better returns on capital for savers and investors.
            </p>
            <p>
              BULLION’s approach to delivering more equitable financial services
              to the world constitutes a variety of dynamics at play in the
              evolution of the global financial system, including the
              implementation of advanced digital technologies to legacy systems.
              The founders of BULLION assert that the new shift in financial
              paradigm is not in the continued separation of traditional and
              DeFi centric economic agents, but one borne of cooperation and
              inclusion. It is the merger of Centralized Finance (CeFi) and
              Decentralized Finance (DeFi) that we call “HyFi”, short for Hybrid
              Finance, to transpire advances in today’s economic system.
            </p>
          </section>
          <section id="problem">
            <h1>2. Problem:</h1>
            ...
            <h3>
              2.1.1 Access Problem Faced by Small to Medium Enterprise (SME)
              Miners
            </h3>
            <p>
              Often, small-to-medium-sized commodity businesses do not have
              access to the most competitively priced financial services, let
              alone a guarantee that even noncompetitively structured services
              will be available. Despite the significant turnover of
              mining/commodity businesses, the liquid assets they deal with, and
              the turnover&apos;s reliability, there is a general commercial
            ...
            <p>
              ...
              only to be presented to those individuals or entities that already
              have substantial wealth or economic power. The result is a
              crystalized wealth structure with little or no economic “class”
              mobility. Economically marginalized individuals or nations remain
              challenged without recourse for social mobility.
            </p>
            <p>
              Savers and investors who are not of a size that falls within the
              threshold of commercial viability to be provided financial
              services and attractive wealth-enhancing opportunities remain
              valuable capital to fuel enterprise operation and growth. Such
              capital lacks the means of being efficiently pooled and mobilized
              to connect with where it is needed, such as the aforementioned
              “SME Miners.” Solving this problem mobilizes more capital in the
              market and presents otherwise off-reach, wealth-enhancing
              opportunities for the neglected savers and investors.
            </p>

            <h3>2.1.3 Economic Instability</h3>
            <p>
              The economic system built on reckless monetary and fiscal policy,
              further amplified by fractional banking, has shown us many times
              throughout history that economies precariously balance between
              stability or order and economic chaos (The Hill).
            </p>
            <p>
              Despite the decisions that have been created and maintained, this
              current situation is being exacerbated by those who possess
              economic and political power. The ramifications of the symptomatic
              instability are borne by the people and entities that are least
          ...
          <section id="solution">
            ...
            <p>
              BULLION proffers the decentralized and collateralized lending and
              borrowing of money between Debtors and Creditors. In the execution
              of a loan agreement in a decentralized environment, there exists
              many advantages over traditional bank loans. In particular, the
              absence of an intermediary renders middleman fees obsolete thereby
              reducing interest rates owed by debtors and enabling more of the
            ...
            <p>
              C-TROY Token is a digital loan agreement, secured on-chain,
              entitling the Creditor to interest payments based on Bullion’s
              proprietary interest optimization mechanism. The following factors
              are considered in the execution of the loan agreement:
            </p>
            <ol>
              <li>
                <h4>Interest Rate (Creditor)</h4>
                <p>
                  The loan agreement can be executed once there is a match of
                  the loan amount and the corresponding interest rate. Creditors
                  can earn interest for supplying loans to Debtors through the
                  TROY token.{" "}
                </p>
              </li>
              <li>
                <h4>Proof-of-Collateral (Debtor)</h4>
                <p>
                  Submit a bank registered collateral in the form of a
                  “Certificate of Deposit” to verify ownership and provide
                  evidence that the collateral is stored securely in a private
                  vault. The credibility of the debtor is secured through the
                  provision of the proof of collateral, serving as a reliable
                  means to verify the legitimacy of the debtor.
                </p>
              </li>
            </ol>
            <p>
              Once the two aforementioned conditions have been satisfied, the
              loan agreement will be executed thereby minting C-TROY token. This
              safeguards Creditors from an event of default by the Debtor,
              ensuring the return of their principal and interest within the
              agreed upon time, whilst providing Debtors with the credibility
              required to obtain the loans.
            </p>
            <div>
              <Image
                width={"100%"}
                height={"100%"}
                src="/bullionecosystem.png"
                layout="responsive"
                objectFit="contain"
                alt="Ecosystem"
              />
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      Banking System Prevailing rate - Bullion Dao Discount
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <p>
              ...
              assets deposited as collateral prior to the minting of the loan
              agreement, C-TROY. If a certificate of deposit for a non-gold
              asset, such as for 1 troy oz of Silver, the following
              ...
              <table id="customers">
                ...
                <tbody>
                  <tr>
                    <td>1</td>
                    <td>
                      1 troy oz of Gold = $1,849{" "}
                      <a href="https://data.chain.link/ethereum/mainnet/commodities/xau-usd">
                        (XAU/USD)
                      </a>{" "}
                      | 1 troy oz of Silver = $24.59{" "}
                      <a href="https://data.chain.link/ethereum/mainnet/commodities/xag-usd">
                        (XAG/USD)
                      </a>
                    </td>
                  </tr>
            ...
            <p>
              NB: this is an illustrative example, and actual calculations will
              be based on prevailing market rates.
            </p>
            <h3>3.1.2 TROY: Interest Token</h3>
            <p>
              Interest is paid by Debtors in the form of the Bullion native
              utility token, TROY. The movements in the TROY token will allow
              Debtors (payers of TROY) and Creditors (receivers of TROY), to
              potentially reduce their interest rate exposure or increase the
              amount received in interest respectively. This forms the utility
              or use case for TROY, which will be offered to users through
              various token sales and listings.
            </p>
            <h3>3.1.3 Depositing & Earning</h3>
            <p>
              Creditors are participants who deposit any one of highly liquid
              stablecoins that are each pegged to 1 US dollar, such as USDT or
              USDC to the protocol. In return, Creditors will be rewarded
              interest based on loans supplied. There are two ways for Creditors
              to earn interest, a “Base Rate” and “Alpha Rate”.
            </p>
            <ul>
              <li>
                <h4>Base Rate:</h4>
                <p>
                  The starting base interest rate will be set at a market
                  competitive APY (equal to other DeFi lending protocols such as
                  Aave, Compound, etc). Interest on loans supplied will be made
                  payable in the BULLION native utility token, TROY.
                </p>
              </li>
              <li>
                <h4>Alpha Rate:</h4>
                <p>
                  For every executed loan agreement, interest is optimized in
                  accordance with Bullion’s proprietary interest optimization
                  mechanism. (this is our way of optimizing the inefficiencies
                  of centralization).
                </p>
              </li>
            </ul>
            <p>
              ...
              ecosystem contributors. They can elect to pledge their TROY to
              earn rewards through the Initial Staking Rewards Pool with a
              variable APY (vesting schedule applied to mitigate dumping) or
              earn fixed rewards through the Perpetual Staking Rewards Pool.
            </p>
          </section>
          <section id="token">
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>5%</td>
                    <td>
                      Vesting until necessary for use. Controlled by the
                      Foundation for the continued development of the protocol
                    </td>
                  </tr>
                  <tr>
                    <td>Marketing</td>
                  ...
                  <tr>
                    ...
                    <td>5%</td>
                    <td>
                      20% Initial Circulating Supply. Remaining vested and
                      released per month over 12 months
                    </td>
                  </tr>
                  <tr>
                    <td>Advisors</td>
          ...
          <section id="overview">
            <h1>7. Overview</h1>
            <p>
              Bullion is a decentralized gold-backed liquidity market protocol
              where users can participate as Creditors or Debtors. Just like in
              traditional finance, Creditors provide liquidity to the Bullion
              loan market to earn interest for a deposit and are also subject to
              receive additional interest upon a match with a Debtor through
              executing a loan agreement. Debtors are able to borrow against
              their collateralized asset, gold, to fund their business
              operations and by borrowing, able to obtain liquidity (working
              capital) without selling their assets and hence, are entitled to
              the potential upside value gain of their underlying collateral.
              ...
              financial services are provided. By applying a global risk pricing
              mechanism and a gold equivalency standard, coupled with advances
              in distributed ledger technology, Bullion offers an alternative,
              peer to peer means to obtain loans thereby enhancing access to
              capital.
            </p>
          </section>
          <section id="team">
            ...
            <ul>
              <li>
                ...
                and researcher. She has been educated in the UK for accounting
                and finance. She established her own financial enterprise which
                provides management consulting, accounting services and a
                research center. Along with chasing her career, she has been
                supporting the management of her father’s business, gold mining
                company, and sought a way of solvency for better financial
                source and services. Therefore, she is now extending her Finsigh
                Investment company with the Bullion Project where SME gold
                miners can get an efficient service through cheaper cost of
                capital compared to traditional banking systems which makes it a
                transformational start-up in Mongolia where it’s based on Hybrid
                Finance, HyFi system which many SME miners and investors can be
                hugely benefited.
              </li>
            </ul>
          ...
          <section id="references">
            ...
            <ul className={styles.references}>
              <li>
                <a href="https://thehill.com/opinion/finance/504702-the-feds-reckless-experiment">
                  https://thehill.com/opinion/finance/504702-the-feds-reckless-experiment
                </a>
              </li>
              <li>
                <a href="https://ncrc.org/disinvestment/">
                  https://ncrc.org/disinvestment/
                </a>
              </li>
              <li>
                <a href="https://www.iowapublicradio.org/2020-12-15/unequal-access-to-banking-and-loans-works-against-black-business-owners">
                  https://www.iowapublicradio.org/2020-12-15/unequal-access-to-banking-and-loans-works-against-black-business-owners
                </a>
              </li>
              <li>
                <a href="https://news.crunchbase.com/news/small-business-startup-capital-black-businesses/">
                  https://news.crunchbase.com/news/small-business-startup-capital-black-businesses/
                </a>
              </li>
            </ul>
          </section>
