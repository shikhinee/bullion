        ...
        <div className={styles.content}>
          ...
          <section id="problem">
            ...
            <ul>
              ...
              <li>Small Banks</li>
              <dd>&#9702; Granted approvals for 18.5% of loan applications to small businesses in 2020</dd>
              <li>Institutional Lenders</li>
              <dd>&#9702; Granted approvals for 22% of loan applications to small businesses in 2020</dd>
              <li>Alternative Lenders</li>
              <dd>&#9702; Granted approvals for 23% of loan applications to small businesses in 2020</dd>
              <li>Credit Unions</li>
              <dd>&#9702; Granted approvals for 22% of loan applications to small businesses in 2020</dd>
            </ul>
            <p><i>Neglected Savers and Investors</i></p>
            <p>The structure of the global economy and the financial system that supports it, allows for attractive wealth enhancing opportunities only to be presented to those persons or entities that already have substantial wealth or economic power. The result is a crystalised wealth structure with little or no economic “class” mobility. Economically marginalised individuals or nations remain that way.</p>
            <p>Savers and investors who are not of a size that fall within the threshold of commercial viability to be provided financial services and attractive wealth enhancing opportunities, remain as valuable capital to fuel enterprise operation and growth. Such capital just lacks the means of being efficiently pooled and mobilised to connect with where it is needed such as the aforementioned “SME Miners”. Solving this problem not only mobilises more capital in the market but it also presents otherwise off reach, wealth enhancing opportunities for the neglected savers and investors in the market.</p>
            <i>Economic Instability</i>
            <p>The economic system built on reckless monetary and fiscal policy and amplified by fractional banking has shown us many times over throughout history that economies precariously balancing between stability or order and economi chaos.</p>
            <p>Despite the decisions that have created and maintained this current situation being made by those who possess economic and political power, the ramifications of the symptomatic instability are borne by the people and entities that are least equipped to handle it.</p>
          </section>
          <section id="solution">
            <h1>3. Solution: BULLION DAO</h1>
            <p>The BULLION DAO proffers the decentralized and collateralized lending and borrowing of money between “Loan Takers” and  “Loan Suppliers”. In the execution of a loan agreement in a decentralized environment, there exists many advantages over traditional bank loans. In particular, the absence of an intermediary renders middleman fees obsolete thereby reducing interest rates owed by debtors and enabling more of the apportioned interest to be delivered to the creditors. A global risk pricing system has been applied to determine the interest on borrowed money coupled with a gold equivalency standard to ensure loans and the corresponding interest rates are determined based on real-world measurements.</p>
            <table id="customers">
              <tr>
                <th>Country</th>
            ...
            <p>“Loan Takers” are participants of the BULLION ecosystem who submit proof of a bank registered collateral deposit in the form of a “Certificate of Deposit” to verify ownership and provide evidence that the collateral is stored securely in a private vault.</p>
            <p>Upon verification of the “Certificate of Deposit” by the BULLION DAO, C-BAU, a 100% gold backed utility token representing 1 troy ounce (oz) of a gold reserve bar, is minted at a 1 troy oz to 1 token ratio. The supply of C-BAU is determined based on the amount of gold that is in reserve. With more gold added to the reserve, more C-BAU will be minted. C-BAU can either be used to exchange for physical gold or staked to execute a loan agreement.</p>
            <p>In order to acquire loans through the BULLION DAO, Loan Takers must “stake” or “collateralize” their C-BAU at a 1 to 1 ratio. This means for every 1 C-BAU that is staked, a risk adjusted percentage of the value of 1 troy oz gold in USD, can be borrowed. This risk adjustment % or debt to equity ratio, is determined by perceived gold volatility. It will likely track the collateralisation ratios, set by the traditional banking sector. In other words, subject to volatility of the price of the collateral, a percentage of the value of the collateral at the time of staking will be the ultimate loan principal amount. 
            For an example consider the information In table 3.1 the current collateral value to loan amount % is given as 82-87%, meaning that if gold is currently valued at $1800 per ounce, the borrower will be able to borrow $1,476-$1566 for every ounce staked.</p>
            <p>Table 3.1: Comparison of how BULLION will be more competitive than the current banking system.  The figures given are for illustrative purposes.</p>
            <table>
              <tr>
                <th>Country</th>
                <th>Collateral</th>
              ...
              <p>At maturity, the loan principal will be returned to the Loan Supplier in the currency on which the loan agreement was executed. Interest incurred from the loan will be made payable solely in the BULLION DAO native utility token, BAU. This forms the utility or use case for BAU, which will be offered to users through various token sales and listings. (see: 3.1.3 Loan Interest)</p>
              <h3>3.1.3 BULLION Gold (C-BAU)- Precious and Other Metals</h3>
              <p>A “Gold-Equivalency Standard” will be applied to all non-gold assets deposited as collateral prior to the minting of C-BAU. For example, if a certificate of deposit for 1troy oz of Gold is submitted, then 1 C-BAU is minted. However, if a  certificate of deposit for a non-gold asset, such as for 1 troy oz of Silver is submitted, the following Gold-Equivalency Standard is applied for the conversion to C-BAU.</p>
            <h2 id="solution-creditors">3.2 Loan Suppliers (Creditors)</h2>
            <h3>3.2.1 Highly Liquid Stablecoins (USDT, USDC, BUSD, TUSD)</h3>
            <p>Loan Suppliers are participants who deposit any one of highly liquid stablecoins that are each pegged to 1 US dollar, such as USDT or USDC to the protocol. In return, Loan Suppliers will be rewarded interest based on loans supplied. The starting interest rate will be set at a market competitive APY (higher than other DeFi lending protocols such as Aave, Compound, etc.) and the longer one supplies the loans, the higher the interest rate. Interest on loans supplied will be made payable in the BULLION DAO native utility token, BAU. This forms the utility or use case for BAU, which will be offered to users through various token sales and listings. (see: 3.1.3 Loan Interest)</p>
            <h2 id="solution-interest">3.3 Loan Interest</h2>
            <h3>3.3.1 BULLION Utility Token (BAU)</h3>
            <p>BAU, is the native utility token for the BULLION DAO, used to pay off interest incurred in the loan agreement between Loan Takers and Loan Suppliers. This token will be listed and traded on both centralized and decentralized digital assets exchanges.</p>
            <p>In order to further incentivize participation on the protocol, an initial staking rewards pool will be launched to reward early ecosystem contributors. They can elect to pledge their BAU to earn rewards through the Initial Staking Rewards Pool with a variable APY (vesting schedule applied to mitigate dumping) or earn fixed rewards through the Perpetual Staking Rewards Pool.</p>
          </section>
          <section id="token">
            <h1>4. Bullion Token Economy</h1>
            <h2 id="token-ecosystem">4.1 Token Ecosystem- Bringing it all Together</h2>
          ...
          <section id="overview">
            <h1>7. Overview</h1>
            <p>The importance of financial stability is well recognized globally, but inequality still pervades the infrastructure on which financial services are provided.</p>
          </section>
          <section id="references">
            <h1>8. References</h1>
            <h3>Mr Ganzorig Volooj - Founder, CEO</h3>
            <ul>
              <li>Mr Ganzorig is a successful businessman who has over 20 years of experience in heavy industry in Mongolia. He is an electrical engineer who later studied further in China for foreign trade and economy which enabled him to cooperate with foreign investors. He started his business in the construction industry in 2010 and extended it into the mining sector from 2011. He is now running his gold mining business i.e. Khamtiin Ekh Bulag LLC in Bureghangai soum, Bulgan aimag, Mongolia.</li>
            </ul>
            <h3>Michael Johnson - Mining Engineer (from TOA) & Metallurgist</h3>
            <ul>
              <li>Mr. Johnson is a qualified engineer with more than 40 years of global experience in the heavy industry, mining and construction sector. He has managed projects for multinational corporations, enterprises, and startups.  He is the President & founder of TOA Consulting, an international consultancy and project management company. His successful track record includes work with globally recognised corporations such as Arcelor Mittal, AHMSA, Mobarakeh Steel Company, SMS Siemac, and Iron Ore Canada, spanning China, North America, South East and Central Asia, and Iran.</li>
            </ul>
            <h3>David Gong - Director: Business Development (Global Crypto)</h3>
            <ul>
              <li>David’s blockchain experience is primarily business development and research, always looking for opportunities to learn and provide a unique perspective. He is an early contributor to Columbia University’s undergraduate organization for distributed ledger technology, Blockchain@Columbia, and Researcher at the CBDC Blockchain Research Institute and Cypherium, a layer-1 blockchain protocol for CBDC interoperability. He holds a B.A. in Political Science from Columbia University.</li>
            </ul>
            <h3>Ranadip - CTO</h3>
            <ul>
              <li>Ranadip leads the design architecture and implementation of distributed systems. He has been working with various teams on Ethereum based projects since 2017. He has also worked on a patented reputation management system for mail prioritization and spam filtering using Hyperledger. His expertise lies in DeFi based projects such as governance and reward management systems. He has also worked previously as a full stack developer mainly working on backend systems based on Python and Node.Js and frontend web applications based on ReactJs.</li>
            </ul>
            <h3>Naranzul Ganzorig - Financial Advisor</h3>
            <ul>
              <li>Mr Ganzorig is a successful businessman who has over 20 years of experience in heavy industry in Mongolia. He is an electrical engineer who later studied further in China for foreign trade and economy which enabled him to cooperate with foreign investors. He started his business in the construction industry in 2010 and extended it into the mining sector from 2011. He is now running his gold mining business i.e. Khamtiin Ekh Bulag LLC in Bureghangai soum, Bulgan aimag, Mongolia.</li>
            </ul>
            <h3>Ireedui Zorigt - Director: Community development, Social media Marketing & Gold Processing Engineer</h3>
            <ul>
              <li>Mr Ganzorig is a successful businessman who has over 20 years of experience in heavy industry in Mongolia. He is an electrical engineer who later studied further in China for foreign trade and economy which enabled him to cooperate with foreign investors. He started his business in the construction industry in 2010 and extended it into the mining sector from 2011. He is now running his gold mining business i.e. Khamtiin Ekh Bulag LLC in Bureghangai soum, Bulgan aimag, Mongolia.</li>
            </ul>
